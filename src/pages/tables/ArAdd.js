...
const ph= localStorage.getItem('ph')
    axios.post(ARBITRE_URL,({'athlete':{'identity_photo':`https://c3dd-197-14-10-36.ngrok.io${ar} `,'photo':`https://c3dd-197-14-10-36.ngrok.io${ph} `,'grade':'2'},'profile':{'cin':cin,'first_name':first_name,'last_name':last_name,'sex':sex,'birthday':birthday,'country':"Tunisie"},'user':{'password':password,'username':username}}),

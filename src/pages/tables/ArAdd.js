...
const gr= localStorage.getItem('gr')
    axios.post(ARBITRE_URL,({'arbitrator':{'identity_photo':`https://41c5-197-14-10-36.eu.ngrok.io${ar} `,'photo':`https://41c5-197-14-10-36.eu.ngrok.io${gr} `,'grade':'2'},'profile':{'phone':phone,'cin':cin,'first_name':first_name,'last_name':last_name,'sex':sex,'birthday':birthday,'country':"Tunisie",'role':1},'user':{'password':phone,'username':phone}}),
